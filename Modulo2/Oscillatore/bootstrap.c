...
void bootstrap(FILE *f){
    ...
    int i=0,j,k,M=10,x,bin=100,taglio=0;         /*M = numero di resampling, 
    ...
    char filemisure[500];
    sprintf(filemisure,"/home/dario/Documents/Metodi/Modulo2/Oscillatore/Bootstrap/resample_binned_X2.txt");
    x2=fopen(filemisure,"w");
    control_file(x2);
    
    sprintf(filemisure,"/home/dario/Documents/Metodi/Modulo2/Oscillatore/Bootstrap/resample_binned_DX2.txt");
...
void read_file_input(){ /*Mi serve solo per leggere il numero di misure N e la larghezza del reticolo L,
 gli altri non mi servono a niente, quindi non gli do nemmeno un nome significativo*/
    FILE *in;
    in = fopen("/home/dario/Documents/Metodi/Modulo2/Oscillatore/input.txt", "r");
    control_file(in);
...
int main(){
    ...
    char path[500];
    sprintf(path ,"/home/dario/Documents/Metodi/Modulo2/Oscillatore/misure.txt"); 
    input = fopen(path, "r");
    control_file(input);
